...
class LoanRejection1Container extends React.Component {
              ...
              <div className='row'>
                <div className='col-md-12 col-sm-12 col-xs-12'>
                  <div className='thankYouDK'>
                    ...
                    <h3>{locale.apology_msg_part1_type1} <br className='brWeb'/> {locale.apology_msg_part2_type1}</h3>
...
export {LoanRejection1Container};
